...
export const menuContent =
  'glass-menu animate-pop z-50 min-w-[200px] max-h-[var(--bits-dropdown-menu-content-available-height,80vh)] overflow-y-auto rounded-[8px] p-1 text-body text-label outline-none'
